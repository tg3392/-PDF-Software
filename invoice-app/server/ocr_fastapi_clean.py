"""
Archiv-Stub: `ocr_fastapi_clean.py` wurde verschoben/archiviert.
Nutze `ocr_fastapi_single.py` als die aktive Wrapper-Datei.
"""

raise RuntimeError("Deprecated: use server/ocr_fastapi_single.py")

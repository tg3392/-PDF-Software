"""
Archiv: Kopie von `ocr_fastapi.py` (original, mehrfach dupliziert/corrupt).
Diese Datei wurde aus dem Produktionsordner entfernt, zur Analyse aufbewahrt.
"""
...
app = FastAPI(title="OCR Wrapper (archived)")
